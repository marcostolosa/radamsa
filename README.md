...
```
 ...
 $ git clone https://github.com/marcostolosa/radamsa.git && cd radamsa && make && sudo make install
...
## Building Radamsa
```
 $ git clone https://github.com/marcostolosa/radamsa.git
 $ cd radamsa
 $ make
...
A: Please file an issue at https://github.com/marcostolosa/radamsa/issues/new if you don't see a similar one already filed, send email (aohelin@gmail.com) or IRC (#radamsa on freenode).
